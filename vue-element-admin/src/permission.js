    ...
    if (to.path === '/login') {
      ...
      if (userInfo.user_name) {
        ...
        try {
          ...
          // const newAuthority = await store.dispatch('user/getNewView')
          // console.log(newAuthority)
          // 2.通过身份获取权限getNewView
          const viewAuthority = await store.dispatch('user/getViewAuthority', { user_id: userInfo.user_id })
